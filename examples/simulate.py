...
def simulate_single(
    ...
    records = langevin_dynamics(state, dt, n_steps, mass, gamma, temperature, a, b, c)
    return records
...
def simulate_batch(
    ...
    records = jax.vmap(langevin_dynamics, in_axes=(0, None, None, None, None, None, None, None, None))(states, dt, n_steps, mass, gamma, temperature, a, b, c)
    return records
...
if __name__ == "__main__":
    ...
    # simulate
    records = simulate_batch(B, D, n_steps, key, dt, mass, gamma, temperature, a, b, c)
